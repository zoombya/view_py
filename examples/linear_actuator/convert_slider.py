#!/usr/bin/env python3
"""
Convert the slider cadnano design to oxView format using view_py.
...
The slider is one component of the linear actuator from:
...
def main():
    ...
    cadnano_path = HERE / "slider.json"
    scaffold_path = HERE / "slider_scaffold.txt"
